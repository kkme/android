...
public class ListHeaderView extends ViewGroup {
	...
	public ListHeaderView(Context context, RefreshableListView list) {
		super(context);
		this.mListView = list;
		this.mMaxPullHeight = ((int) (context.getResources()
				.getDisplayMetrics().density * 200.0F + 0.5F));
	}
	...
	public void setOnHeaderViewOpendListener(
			OnHeaderViewOpenedListener onHeaderViewOpenedListener) {
	...
	private class CloseTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			if (ListHeaderView.this.mNextState != -1) {
				ListHeaderView.this.mListView
						.setState(ListHeaderView.this.mNextState);
				ListHeaderView.this.mNextState = -1;
			}
			ListHeaderView.this
					.setHeaderHeight((int) (ListHeaderView.this.mInitHeight - ListHeaderView.this.mDistance
							* x));
			...
			if (!this.isClose) {
				...
				if (ListHeaderView.this.mOnHeaderViewChangedListener != null) {
					ListHeaderView.this.mOnHeaderViewChangedListener
							.onViewUpdating(ListHeaderView.this);
				}
		...
		public void onTick(long millisUntilFinished) {
			int interval = (int) (AnimationUtils.currentAnimationTimeMillis() - this.mStart);
			...
			if (this.isClose) {
				...
				ListHeaderView.this
						.setHeaderHeight((int) (ListHeaderView.this.mInitHeight * x));
			}
		}
