...
public class ContextUtil {
	...
	private static Context mContent = MyApplication.getInstance()
	...
	public static String getDeviceId() {
		TelephonyManager tm = (TelephonyManager) mContent
				.getSystemService(Context.TELEPHONY_SERVICE);
		String deviceId = tm.getDeviceId();
		if (deviceId == null) {
			deviceId = Secure.getString(mContent.getContentResolver(),
					Secure.ANDROID_ID);
		}
