...
public class RoundProgressBar extends TextView {
	...
	public RoundProgressBar(Context context, AttributeSet attrs) {
		...
		mButtomColor = array.getColor(
				R.styleable.RoundProgressBar_bottom_color, Color.GRAY);
		mBottomPaint.setColor(mButtomColor);
		mMaxProgress = array.getInt(R.styleable.RoundProgressBar_max_progress,
				100);
		...
		mDefaultProgress = array.getInt(
				R.styleable.RoundProgressBar_rb_defaultvalue, 0);
	...
	public void startAnim(int progress, int duration) {
		...
		mProcessRInterval = Math.max(1, mTimerInterval * mAnimProgress
				/ duration);
