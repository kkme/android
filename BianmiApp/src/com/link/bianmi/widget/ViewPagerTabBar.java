...
public class ViewPagerTabBar extends HorizontalScrollView {
	...
	public ViewPagerTabBar(Context context, AttributeSet attrs, int defStyle) {
		...
		//
		// indicatorColor =
		// a.getColor(R.styleable.PagerSlidingTabStrip_indicatorColor,
		// indicatorColor);
		// underlineColor =
		// a.getColor(R.styleable.PagerSlidingTabStrip_underlineColor,
		// underlineColor);
		// dividerColor =
		// a.getColor(R.styleable.PagerSlidingTabStrip_dividerColor,
		// dividerColor);
		// indicatorHeight =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_indicatorHeight,
		// indicatorHeight);
		// underlineHeight =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_underlineHeight,
		// underlineHeight);
		// dividerPadding =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPadding,
		// dividerPadding);
		// tabPadding =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_tabPaddingLeftRight,
		// tabPadding);
		// tabBackgroundResId =
		// a.getResourceId(R.styleable.PagerSlidingTabStrip_tabBackground,
		// tabBackgroundResId);
		// shouldExpand =
		// a.getBoolean(R.styleable.PagerSlidingTabStrip_shouldExpand,
		// shouldExpand);
		// scrollOffset =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_scrollOffset,
		// scrollOffset);
		// textAllCaps =
		// a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCaps,
		// textAllCaps);
		//
		// a.recycle();
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int state) {
			...
			if (ViewPagerTabBar.this.getY() != 0) {
				ViewPropertyAnimator anim = ViewPagerTabBar.this.animate();
				anim.translationY(0);
			}
		}
