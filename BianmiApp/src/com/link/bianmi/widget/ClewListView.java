 ...
 * 
 */
public class ClewListView extends ListView implements OnScrollListener {
	...
	public ClewListView(Context context) {
		super(context);
		mContext = context;
		initClewListView();
	}

	public ClewListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initClewListView();
	...
	public ClewListView(Context context, AttributeSet attrs, int defStyle) {
