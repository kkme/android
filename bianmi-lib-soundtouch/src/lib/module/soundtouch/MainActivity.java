 ...
 * 
 * import lib.module.soundtouch.R; import lib.module.soundtouch.R.id;
 * 
 * import android.os.Bundle; import android.app.Activity; import
 * android.util.Log; import android.view.Menu; import android.view.View; import
 ...
 * 
 * private Button recorderStartBut; private Button recorderStopBut; private
 * Button playerStartBut; private Button playerStopBut;
 * 
 * private TextView pitchShow; private SeekBar pitchSeekBar;
 * 
 * private TextView tempoShow; private SeekBar tempoSeekBar;
 * 
 ...
 * .soundTouchgethVersion(); // Log.d(TAG, "get soundtouch version :" +
 * versionCode); }
 * 
 * @Override protected void onPause() { super.onPause();
 * 
 * soundTouchRec.stopRecorder(); soundTouchRec.stopPlay(); }
 * 
 ...
 * 
 * @Override public void onClick(View v) { soundTouchRec.startRecord(); } };
 * 
 * private OnClickListener recordStopListener = new OnClickListener() {
 * 
 * @Override public void onClick(View v) { lastRecordFile =
 ...
 * 
 * @Override public void onClick(View v) { soundTouchRec.stopPlay(); } };
 * 
 * private OnSeekBarChangeListener onPitchSeekBarListener = new
 ...
 * boolean fromUser) {
 * 
 * float pitch = (progress - 1000) / 100.0f; pitchShow.setText("Pitch Shift: " +
 * pitch); } };
 * 
 * private OnSeekBarChangeListener onTempoSeekBarListener = new
 * OnSeekBarChangeListener() {
 * 
 * @Override public void onStopTrackingTouch(SeekBar seekBar) {
 * 
 ...
 * boolean fromUser) {
 * 
 * float tempo = (progress - 5000) / 100.0f; tempoShow.setText("Tempo Change: "
 * + tempo + "%"); } };
 * 
 * }
 */